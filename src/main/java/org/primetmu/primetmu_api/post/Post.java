...
public class Post {
    ...
    public Post(UUID id, UUID userId, UUID imageId, String category, String itemType, String title,
    ...
    public Post(UUID userId, UUID imageId, String category, String itemType, String title, String description,
            String location,
            BigDecimal price) {
        this.userId = userId;
        this.imageId = imageId;
    ...
    public void setUserId(UUID newId) {
        this.userId = newId;
    }
